 ...
 * @package       Cake.Error
 */
class HException extends RuntimeException {
/**
...
class CacheCheckException extends HException {
    protected $_messageTemplate = 'the update delete of %s missing cache identifier, it will cause cache mistake.';
 ...
 * @package       Cake.Error
 */
class MissingControllerException extends HException {
 ...
 * @package       Cake.Error
 */
class MissingActionException extends HException {
 ...
 * @package       Cake.Error
 */
class PrivateActionException extends HException {
 ...
 * @package       Cake.Error
 */
class MissingComponentException extends HException {
 ...
 * @package       Cake.Error
 */
class MissingBehaviorException extends HException {
 ...
 * @package       Cake.Error
 */
class MissingViewException extends HException {
 ...
 * @package       Cake.Error
 */
class MissingLayoutException extends HException {
    protected $_messageTemplate = 'Layout file "%s" is missing.';
}

class MissingElementException extends HException {
 ...
 * @package       Cake.Error
 */
class MissingHelperException extends HException {
 ...
 * @package       Cake.Error
 */
class MissingDatabaseException extends HException {
 ...
 * @package       Cake.Error
 */
class MissingConnectionException extends HException {
 ...
 * @package       Cake.Error
 */
class MissingTaskException extends HException {
 ...
 * @package       Cake.Error
 */
class MissingShellMethodException extends HException {
 ...
 * @package       Cake.Error
 */
class MissingShellException extends HException {
 ...
 * @package       Cake.Error
 */
class MissingDatasourceConfigException extends HException {
 ...
 * @package       Cake.Error
 */
class MissingDatasourceException extends HException {
 ...
 * @package       Cake.Error
 */
class MissingTableException extends HException {
 ...
 * @package       Cake.Error
 */
class MissingModelException extends HException {
 ...
 * @package       Cake.Error
 */
class MissingTestLoaderException extends HException {
 ...
 * @package       Cake.Error
 */
class MissingPluginException extends HException {
 ...
 * @package       Cake.Error
 */
class CacheException extends HException { }
 ...
 * @package       Cake.Error
 */
class RouterException extends HException { }
 ...
 * @package       Cake.Error
 */
class LogException extends HException { }
 ...
 * @package       Cake.Error
 */
class XmlException extends HException { }
 ...
 * @package       Cake.Error
 */
class ConsoleException extends HException { }

/**
 * 
 * 
 */
class UndefinedPropertyException extends HException { }

class ModifyReadOnlyModelException extends HException { }

class DatabaseException extends HException { }
