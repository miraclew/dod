...
final class Debug
{
    ...
    public static function varDump( $var, $exit = false )
    {
        ...
        <div class="ow_debug_cont">
            <div class="ow_debug_body">
                <div class="ow_debug_cap vardump">Debug - Vardump</div>
                <div>
    ...
    public static function printDebugMessage( $data, $format = true )
    {
        ...
        if ( $format )
        {
            ...
            <div class="ow_debug_cont">
                <div class="ow_debug_body">
                    <div class="ow_debug_cap ' . strtolower($data['type']) . '">Debug - ' . $data['type'] . '</div>
                    <table>
                        <tr>
                        ...
                        <tr>
                            <td class="lbl">Sql:</td>
                            <td class="cnt">' . (isset($data['sql']) ? $data['sql'] : '') . '</td>
                        </tr>
                        <tr>
                            <td class="lbl">File:</td>
                            <td class="cnt">' . $data['file'] . ' (Line: ' . $data['line'] . ')</td>
                        </tr>
                        ' . (!empty($data['trace']) ?
                    '<tr>
    ...
    private static function addDebugStyles()
    {
        echo '
        <style>
            .ow_debug_cont{padding:15px 0;margin:0 auto;}
